...
public class EndScreenSinglePlayer1 extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // test out using the custom class
        // create an object instance of your custom class EndOfRoundOrGameResults to use for the
        // end of the game
        EndOfRoundOrGameResults myEndOfRoundOrGameResults = new EndOfRoundOrGameResults(this, "game");

        // get the number of players in the current game by checking how many game instances are in allGameInstances
        int numPlayers = MainActivity.allGameInstances.size();
        myEndOfRoundOrGameResults.setNumPlayers(numPlayers);
...
//                        Log.d("Hello", "xxxx 3.4" + victoryMessage);
//                    }else{
//                        victoryMessage = (victoryMessage + winners.get(f) + " and ");
//                        Log.d("Hello", "xxxx 3.5" + winners.get(f));
//                    }
//
//                }
//
//            }
//
//            Log.d("Hello", "xxxx 8.4" + victoryMessage);
