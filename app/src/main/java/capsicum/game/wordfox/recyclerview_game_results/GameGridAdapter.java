...
import capsicum.game.wordfox.recyclerview_game_results.itemtypes.TypeGrid;
import capsicum.game.wordfox.recyclerview_game_results.itemtypes.TypePlayerResultDetails;
import capsicum.game.wordfox.recyclerview_game_results.viewholders.GridViewHolder;
import capsicum.game.wordfox.recyclerview_game_results.viewholders.PlayerDetailsViewHolder;
import timber.log.Timber;

public class GameGridAdapter extends RecyclerView.Adapter<BaseResultViewHolder> {
    ...
    @NonNull
    @Override
    public BaseResultViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View v;
        switch (viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull BaseResultViewHolder viewHolder, int position) {
